...
_CATEGORY_MODULES = {
    "ingest": "reader.plugins.manifests.ingest",
    "transform": "reader.plugins.manifests.transform",
    "plot": "reader.plugins.manifests.plot",
    "export": "reader.plugins.manifests.export",
    "validator": "reader.plugins.manifests.validator",
}
