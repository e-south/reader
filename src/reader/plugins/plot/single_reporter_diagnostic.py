...
class SingleReporterDiagnosticPlot(FigurePlotPlugin):
    ...
    def render(self, ctx, inputs, cfg: SingleReporterDiagnosticCfg) -> list[PlotFigure]:
        from reader.domains.plate_reader.plots.single_reporter_diagnostic import (  # noqa: PLC0415
            prepare_single_reporter_diagnostics,
        )
        from reader.domains.plate_reader.plots.single_reporter_diagnostic_render import (  # noqa: PLC0415
