...
DESCRIPTOR = NotebookTemplateDescriptor(
    template="notebook/retron_sponge",
    domain="plate_reader",
    family="screen_review",
    summary="Retron sponge screen review notebook with plot portfolio and semantic-table focus.",
    tags=("eda", "microplate", "retron", "sponge"),
    source_package=__package__,
    source_name="retron_sponge.marimo.py.txt",
