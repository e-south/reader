...
--------------------------------------------------------------------------------
<reader project>
reader/processors/sfxi/writer.py
...
def write_outputs(*, vec8: pd.DataFrame, log: Dict[str, Any], out_dir: Path | str,
                  subdir: str, vec8_filename: str, log_filename: str) -> Dict[str, Path]:
