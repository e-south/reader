...
--------------------------------------------------------------------------------
<reader project>
src/reader/lib/microplates/style.py
...
def use_style(rc: Optional[dict] = None, color_cycle: Optional[Iterable[str]] = None):
...
def new_fig_ax(fig_kwargs: Optional[dict] = None):
    """
    ...
    _ALLOWED = {
        "num", "figsize", "dpi", "facecolor", "edgecolor", "frameon", "clear",
        "constrained_layout", "layout", "squeeze", "subplot_kw", "gridspec_kw",
        "sharex", "sharey",
    }
