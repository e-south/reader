...
from reader_workbench.workbench import PluginStep, resolve_workbench
from reader_workbench.workbench.engine.runtime import run_spec
from reader_workbench.workbench.engine.setup import resolve_palette_book, slice_pipeline_steps
...
def test_resolve_palette_book_reports_non_dependency_import_failure(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("reader_workbench.workbench.engine.setup.import_module", _boom)
