...
from reader_workbench.errors import ExecutionError, RecordError
from reader_workbench.protocols import ProtocolBinding, builtin_protocol_catalog
from reader_workbench.tests.support import record_successful_invocation
...
from reader_workbench.workbench.engine import execute_step
from reader_workbench.workbench.engine.execution import _runtime_provenance_inputs
from reader_workbench.workbench.engine.file_outputs import FileOutputTransaction
from reader_workbench.workbench.graph import FileRef, PluginStep, ProvenanceInput, RecordRef, ResourceRef
from reader_workbench.workbench.ports import dataframe_input, dataframe_output, file_path_input, file_path_output
from reader_workbench.workbench.records import RecordStore, verify_record_store
from reader_workbench.workbench.records.model import record_revision_digest
...
def _context(tmp_path: Path) -> RunContext:
    ...
    return RunContext(
        ...
        logger=logging.getLogger("reader_workbench.tests.input_snapshot"),
        palette_book=None,
