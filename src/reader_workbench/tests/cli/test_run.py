...
from reader_workbench.tests.support import base_reader_config, cli_success_data, load_decl, write_config
from reader_workbench.workbench.cli import app
from reader_workbench.workbench.cli.helpers import resolve_pipeline_step_id
...
def test_run_only_shows_next_steps(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("reader_workbench.workbench.engine.run_job", _fake_run_job)
