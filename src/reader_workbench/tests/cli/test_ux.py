...
from reader_workbench.workbench import PluginSemantics, cli
from reader_workbench.workbench.assets import build_plugin_asset
from reader_workbench.workbench.config import ReaderSpec
from reader_workbench.workbench.engine import build_next_steps
...
def test_plugins_command_shows_workbench_semantics(monkeypatch) -> None:
    ...
    monkeypatch.setattr(cli.shared, "console", test_console)
    monkeypatch.setattr(
        "reader_workbench.runtime.builtin_runtime",
