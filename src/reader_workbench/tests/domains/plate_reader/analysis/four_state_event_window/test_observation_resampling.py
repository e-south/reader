...
from reader_workbench.domains.plate_reader.analysis.four_state_event_window.observation_resampling import (
    descriptive_resampling_records,
    joint_state_descriptive_resampling_draws,
)
from reader_workbench.domains.plate_reader.analysis.four_state_event_window.seeds import stable_seed
from reader_workbench.domains.plate_reader.analysis.four_state_event_window.sources import STATE_ORDER
from reader_workbench.tests.domains.plate_reader.analysis.four_state_event_window.test_four_state_event_window_contracts import (
    _payload,
)
...
def test_reference_descriptive_resampling_draws_keep_anchored_magnitude_at_zero() -> None:
    request = FourStateEventWindowAnalysisSpec.from_mapping(_payload())
    records = []
