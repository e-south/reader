...
def test_prepare_four_state_event_window_diagnostic_selects_one_explicit_subject() -> None:
...
def test_prepare_four_state_event_window_diagnostic_rejects_a_missing_subject() -> None:
    with pytest.raises(
        ValueError,
...
def test_render_four_state_event_window_diagnostic_has_four_neutral_panels() -> None:
