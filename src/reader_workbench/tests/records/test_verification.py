...
import reader_workbench.workbench.records.verification as verification_module
...
from reader_workbench.workbench.graph import FileRef, ProvenanceInput, RecordRef
...
def test_verifier_reports_artifact_io_failures_as_structured_issues(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("reader_workbench.workbench.records.verification.sha256_file", _unreadable)
