...
from reader_workbench.plugins.transform.sample_metadata import SampleMetadataCfg, SampleMetadataMerge


def _ctx(exp_dir: Path):
    return SimpleNamespace(exp_dir=exp_dir, logger=logging.getLogger("reader_workbench.tests"))
