...
from reader_workbench.plugins.transform.sample_map import SampleMapCfg, SampleMapMerge
from reader_workbench.workbench import PluginSemantics
from reader_workbench.workbench.assets import build_plugin_asset
from reader_workbench.workbench.engine import _resolve_runtime_output_ports


def _ctx():
    return SimpleNamespace(logger=logging.getLogger("reader_workbench.tests"))
