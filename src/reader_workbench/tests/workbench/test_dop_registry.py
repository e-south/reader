...
from reader_workbench.workbench.dop import builtin_dop_registry
from reader_workbench.workbench.inspection.readiness import READINESS_CAPABILITY_KEYS, READINESS_STATES
...
def test_dop_classes_cli_filters_by_protocol() -> None:
    ...
    result = runner.invoke(
        cli.app,
        ["dop", "classes", "--protocol", "plate_reader/single_reporter_screen", "--format", "json"],
    )
