...
from ..common import select_exact_observations
...
def select_snapshot_rows(
    *,
    ...
    if snapped.empty:
        ...
        fallback = select_exact_observations(fallback, where="snapshot summary")
        if fallback.empty:
    ...
    snapped = select_exact_observations(snapped, where="snapshot summary")
