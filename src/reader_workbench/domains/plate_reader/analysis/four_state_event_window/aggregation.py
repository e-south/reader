"""Aggregate four-state event-window well summaries into design-level records."""
...
def _aggregate_state_values(wells: pd.DataFrame, *, request: FourStateEventWindowAnalysisSpec) -> pd.DataFrame:
