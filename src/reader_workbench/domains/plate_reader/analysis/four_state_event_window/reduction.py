"""Four-state event-window adapter to the assay-neutral temporal reducer."""
...
def four_state_event_window_temporal_spec(
    reduction: ReductionSpec,
    quality: QualitySpec,
    *,
    absolute_window_h: tuple[float, float] | None = None,
) -> TemporalReductionSpec:
    """Project four-state event-window policy into the neutral temporal contract.

    Four-state event-window reductions remain event-relative unless an explicit
