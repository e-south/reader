...
from .contracts import FourStateEventWindowAnalysisSpec, ObservationStat
from .seeds import stable_seed
from .sources import STATE_ORDER


def descriptive_resampling_records(wells: pd.DataFrame, *, request: FourStateEventWindowAnalysisSpec) -> pd.DataFrame:
