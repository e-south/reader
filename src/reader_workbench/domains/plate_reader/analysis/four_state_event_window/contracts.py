...
class FourStateEventWindowSourceSpec:
...
@dataclass(frozen=True)
class FourStateEventWindowAnalysisSpec:
    source: FourStateEventWindowSourceSpec
    event: EventSpec
    ...
    @classmethod
    def from_mapping(cls, value: object) -> FourStateEventWindowAnalysisSpec:
        fields = {
            "source",
            "event",
            "reductions",
