...
class DualReporterTriptychPlot(FigurePlotPlugin):
    ...
    def render(self, ctx, inputs, cfg: DualReporterTriptychCfg) -> list[PlotFigure]:
        from reader_workbench.domains.plate_reader.analysis.timepoints import (  # noqa: PLC0415
            infer_acquisition_transition_time_h,
        )
        from reader_workbench.domains.plate_reader.ordering import order_levels  # noqa: PLC0415
        from reader_workbench.domains.plate_reader.plots.dual_reporter_triptych import (  # noqa: PLC0415
            build_triptych_data,
            choose_time,
        )
