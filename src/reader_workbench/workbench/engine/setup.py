...
from reader_workbench.workbench.records.identity import digest_json
...
def resolve_palette_book(*, decl: WorkbenchDecl, steps: list[Any], dry_run: bool) -> Any:
    ...
    try:
        mod = import_module("reader_workbench.plotting.style")
    ...
    if palette_book_cls is None or available_palettes is None:
        raise ConfigError(
            "reader_workbench.plotting.style must expose PaletteBook and available_palettes for plotting.palette support."
        )
