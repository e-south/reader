...
def _registry():
    return _load("reader_workbench.workbench.dop").builtin_dop_registry()
...
def data_classes(
    ...
    inspection_dop = _load("reader_workbench.workbench.inspection.dop")
...
def ready_specs(
    ...
    registry = _registry()
    inspection_dop = _load("reader_workbench.workbench.inspection.dop")
    readiness = _load("reader_workbench.workbench.inspection.readiness")
    fmt = normalize_output_format(format)
    try:
