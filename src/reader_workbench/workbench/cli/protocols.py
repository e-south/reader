...
def protocols(
    name: str | None = typer.Argument(
        ...
        help=(
            ...
            "(e.g., plate_reader/dual_reporter_screen or plate_reader/single_reporter_screen)."
        ),
    ),
    ...
    inspection_protocols = _load("reader_workbench.workbench.inspection.protocols")
    inspection_runtime = _load("reader_workbench.workbench.inspection.runtime")
    inspection_semantics = _load("reader_workbench.workbench.inspection.semantics")
    try:
        ...
        if name:
            ...
            try:
                bound_protocol = runtime.bind_protocol(
                    _load("reader_workbench.protocols").ProtocolBinding(id=descriptor.protocol)
                )
...
def init(
    ...
    protocol: str = typer.Option(
        ...
        help=(
            ...
            "or plate_reader/single_reporter_screen."
        ),
    ),
    ...
    example_document = _load("reader_workbench.workbench.inspection.protocols").protocol_example_document(descriptor)
